    ...
    <div className="px-6 pb-28 pt-4">
       <div className="flex items-center justify-between mb-6">
            ...
            <div className="bg-brand-primary/10 px-3 py-1 rounded-full">
                <span className="text-xs font-bold text-brand-primary">Sua Posição: {userRank > 0 ? userRank : '-'}º</span>
            </div>
       </div>

       <div className="bg-white rounded-3xl shadow-soft border border-gray-100 overflow-hidden flex flex-col">
          {/* Cabeçalho da Tabela */}
          <div className="flex items-center gap-4 p-4 bg-gray-50 border-b border-gray-100 text-xs font-bold text-gray-400 uppercase tracking-wider sticky top-0 z-10 bg-white shadow-sm">
